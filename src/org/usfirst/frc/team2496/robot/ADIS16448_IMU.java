...
public class ADIS16448_IMU extends GyroBase implements Gyro, PIDSource, LiveWindowSendable {
  ...
  private double a_x =0.0d;
  private double a_y =0.0d;
  private double a_z =0.0d;
  ...
  private void calculate() {
    ...
    while (!m_freed.get()) {
      ...
      do {
        ...
        //System.out.println("ACCELREOMTER: " + ay);
        
        a_x = ax;
        a_y = ay;
        a_z = az;
       
        SmartDashboard.putString("ay", ay+"");
        SmartDashboard.putString("ax", ax+"");
        SmartDashboard.putString("az", az+"");
      ...
      synchronized (this) {
       ...
       /*
        m_integ_gyro_x += (gyro_x) * dt;
        m_integ_gyro_y += (gyro_y) * dt;
        m_integ_gyro_z += (gyro_z) * dt;
       */
  ...
  public synchronized double getAZ() {
	  return a_z;
  }
